...
public class ChatClient extends Frame implements ActionListener,Runnable{
	...
	TextField txt_server_ip;//서버아이피입력필드
	...
	public ChatClient() {
		...
		txt_server_ip=new TextField("192.168.0.95");//자신의 ip
		txt_name=new TextField("부공음악",15);
		...
		btn_send.addActionListener(this);//채팅 전송 버튼 수신기 부착
		txt_input.addActionListener(this);//채팅 입력창 버튼 수신기 부착
		...
		add(chat, "채팅창");
		cl.show(this, "접속창");
		setBounds(250,250,300,300);//위치,크기 동시지정
		setVisible(true);
